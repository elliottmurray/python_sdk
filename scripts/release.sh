...
cat open_analytics/__version__.py | sed "s/__version__ = .*/__version__ = '${VERSION}'/" > tmp-version
mv tmp-version open_analytics/__version__.py
...
git add CHANGELOG.md open_analytics/__version__.py
